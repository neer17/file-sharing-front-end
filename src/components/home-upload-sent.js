                    ...
                    <div className={'app-card-content-inner'}>
                        ...
                        <div className={'app-home-uploading'}>
                            ...
                            <div className={'app-upload-sent-message app-text-center'}>
                                <h2>Files sent!</h2>
                                <p>You have sent an email to {toEmail} with a download link. The link will expire in 30
                                    days.</p>
                            </div>
                            <div className={'app-upload-sent-actions app-form-actions'}>
                                ...
                                }} className={'app-button primary'} type={'button'}>View file
                                </button>
                                <button onClick={() => {
                                ...
                                }} className={'app-button'} type={'button'}>Send another file
                                </button>
                            </div>
                        </div>
                    </div>
